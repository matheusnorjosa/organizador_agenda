...
- Remove uma agenda da conta Google, com aviso das consequências e confirmação (`/remover_agenda`)
...
| `/remover_agenda` | Remove uma agenda da conta Google (pede confirmação) |
